...
<body>
    ...
    <main> 
                        ...
                        <div class="row align-items-center">
                            <div class="col-xl-7 col-lg-8 col-md-10 ">
                                ...
                                <div class="video-icon">
                                    <a class="popup-video btn-icon" href="https://www.youtube.com/watch?v=9HwSOICYy7U" data-animation="bounceIn" data-delay=".4s">
                                        <i class="fas fa-play"></i>
                                    </a>
                                </div>
                                <div class="hero__caption">
                                    <span data-animation="fadeInUp" data-delay=".3s">Your Link to Expert Pet Care</span>
                                    <h1 data-animation="fadeInUp" data-delay=".3s">Welcome to PetPal</h1>
                                    <a href="#" class="hero-btn" data-animation="fadeInLeft" data-delay=".3s">Download Our App<i class="ti-arrow-right"></i> </a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-xl-7 col-lg-8 col-md-10 ">
                                ...
                                <div class="hero__caption">
                                    <span data-animation="fadeInUp" data-delay=".3s">Your Link to Expert Pet Care</span>
                                    <h1 data-animation="fadeInUp" data-delay=".3s">Welocme to PetPal</h1>
                                    <a href="#" class="hero-btn" data-animation="fadeInLeft" data-delay=".3s">Download Our App<i class="ti-arrow-right"></i> </a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="about-area fix">
            ...
            <div class="about-details">
                <div class="right-caption">
                    ...
                    <h2>We Are Committed to Providing <br>Exceptional Service</h2>
                    </div>
                    <div class="about-more">
                    <p class="pera-top">Our dedication to excellence drives us to continually improve and offer services that exceed expectations. <br>We ensure that every interaction reflects our commitment to quality and care.</p>
                    <p class="mb-65 pera-bottom">At our core, we believe in creating meaningful connections with our customers. We strive to deliver personalized experiences that leave a lasting impression, ensuring your satisfaction at every touchpoint. Let us take care of the details so you can focus on what truly matters.</p>                       
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-gallery mb-30">
                            ...
                            <div class="gallery-img size-img" style="background-image: url({{ asset('frontend/assets/img/gallery/gallery1.png') }});"></div>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-6 col-sm-6">
                        <div class="single-gallery mb-30">
                            <div class="gallery-img size-img" style="background-image: url({{ asset('frontend/assets/img/gallery/gallery2.png') }});"></div>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-6 col-sm-6">
                        <div class="single-gallery mb-30">
                            <div class="gallery-img size-img" style="background-image: url({{ asset('frontend/assets/img/gallery/gallery3.png') }});"></div>
                        </div>
                    </div>
                    <div class="col-lg-4  col-md-6 col-sm-6">
                        <div class="single-gallery mb-30">
                            <div class="gallery-img size-img" style="background-image: url({{ asset('frontend/assets/img/gallery/gallery4.png') }});"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row justify-content-sm-center">
                    <div class="cl-xl-7 col-lg-8 col-md-10">
                        <!-- Section Tittle -->
                        <div class="section-tittle text-center mb-70">
                            <span>We have Professional Service Provders </span>
                            <h2>Our Best Service Providers</h2>
                        </div> 
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            ...
                            <div class="team-caption">
                                <span>Dog Wing</span>
                                <h3><a href="#">Dehiwala-Mount Lavinia</a></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            ...
                            <div class="team-caption">
                                <span>Dog Care Clinic</span>
                                <h3><a href="#">Unawatuna</a></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-30">
                            ...
                            <div class="team-caption">
                                <span>PetsVCare Animal Hospitals</span>
                                <h3><a href="#">Colombo 5</a></h3>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- Team End -->
        <!--? Testimonial Start -->
        <div class="testimonial-area testimonial-padding section-bg" data-background="{{ asset('frontend/assets/img/gallery/section_bg03.png') }}">
            <div class="container">
                        ...
                        <div class="h1-testimonial-active dot-style">
                                ...
                                <div class="testimonial-caption ">
                                    ...
                                    <div class="testimonial-founder">
                                        <div class="founder-img mb-40">
                                            <img src="{{ asset('frontend/assets/img/gallery/testi-logo.png') }}" alt="">
                            ...
                            <div class="single-testimonial text-center">
                                <div class="testimonial-caption ">
                                    ...
                                    <div class="testimonial-top-cap">
                                        <p>“Animals are reliable, many full of love, true in their affections, predictable in their actions, grateful, and loyal. Difficult standards for people to live up to”</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="contact-animal-owner section-bg" data-background="{{ asset('frontend/assets/img/gallery/section_bg04.png') }}">
            <div class="container">
                    ...
                    <div class="col-lg-8">
                        <div class="contact_text text-center">
                            ...
                            <div class="contact_btn d-flex align-items-center justify-content-center">
                                ...
                                <p>Or<a href="#"> +94 112 531 825</a></p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-5">
                        <div class="single-footer-caption mb-50">
                            <div class="footer-tittle">
                                <h4>Get in Touch</h4>
                                <ul>
                                 <li><a href="#">+94 112 531 825</a></li>
                                 <li><a href="#"> petpal@gmail.com</a></li>
                                 <li><a href="#">Union Place, Colombo 02,  Sri Lanka</a></li>
                             </ul>
                            </div>
                        </div>
                    </div>
